...
export const ICONS = {
  ...
  checks: (
    <>
      {stroke('m1.8 12.8 4.2 4.2L14.4 8')}
      {stroke('m8.6 14.6 2.4 2.4L22.2 6.4')}
    </>
  ),
  moon: stroke('M21 12.8A9 9 0 1 1 11.2 3a7 7 0 0 0 9.8 9.8Z'),
  dnd: (
    <>
  ...
  pin: (
    <>
      {stroke('M12 17v5')}
      {stroke('M9 3h6l-.75 7.09a4.5 4.5 0 0 0 1.83 4.07l1.42 1.05a.75.75 0 0 1-.45 1.35H6.95a.75.75 0 0 1-.45-1.35l1.42-1.05a4.5 4.5 0 0 0 1.83-4.07Z')}
    </>
  ),
  grip: (
    <>
      {fill('M9 6.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Z')}
      {fill('M9 12a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Z')}
      {fill('M9 17.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Z')}
      {fill('M18 6.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Z')}
      {fill('M18 12a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Z')}
      {fill('M18 17.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Z')}
    </>
  ),
  mini: (
    <>
  ...
  users: (
    <>
      ...
      {stroke('M9 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8Z')}
      {stroke('M22 21v-2a4 4 0 0 0-3-3.87')}
      {stroke('M16 3.13a4 4 0 0 1 0 7.75')}
    </>
  ),
  userPlus: (
    <>
  ...
  copy: (
    <>
      {stroke('M9 9.5h10a1.5 1.5 0 0 1 1.5 1.5v9a1.5 1.5 0 0 1-1.5 1.5H9A1.5 1.5 0 0 1 7.5 20v-9A1.5 1.5 0 0 1 9 9.5Z')}
      {stroke('M4.5 14.5h-1a1.5 1.5 0 0 1-1.5-1.5V4a1.5 1.5 0 0 1 1.5-1.5H12A1.5 1.5 0 0 1 13.5 4v1')}
    </>
  ),
  crown: (
    <>
      {stroke('m3 8 4.5 3.5L12 5l4.5 6.5L21 8l-1.6 9.2a1 1 0 0 1-1 .8H5.6a1 1 0 0 1-1-.8Z')}
    </>
  ),
  radio: (
    <>
      {stroke('M12 14a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z')}
      {stroke('M8.5 8.5a5 5 0 0 0 0 7')}
      {stroke('M15.5 8.5a5 5 0 0 1 0 7')}
      {stroke('M5.6 5.6a9 9 0 0 0 0 12.8')}
      {stroke('M18.4 5.6a9 9 0 0 1 0 12.8')}
    </>
  ),
  logout: (
    <>
  ...
  send: (
    <>
      {stroke('m22 2-7 20-4-9-9-4Z')}
      {stroke('M22 2 11 13')}
    </>
  ),
  lock: (
    <>
      {stroke('M5 11h14a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1v-8a1 1 0 0 1 1-1Z')}
