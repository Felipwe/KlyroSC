...
export const pt: Dict = {
  ...
  social: {
    ...
    errors: {
      ...
      no_chat_key: 'Esse amigo ainda não pode usar o chat  precisa atualizar o KlyroSC.',      invalid_avatar: 'Não deu para usar essa imagem. Tente outra.',      user_not_found: 'Ninguém com esse ID foi encontrado.',
