export const en = {
  ...
  social: {
    ...
    errors: {
      ...
      no_chat_key: 'This friend cannot chat yet  they need to update KlyroSC.',      invalid_avatar: 'That image could not be used. Try another one.',      user_not_found: 'Nobody with that ID was found.',
